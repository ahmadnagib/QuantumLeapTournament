...
def testStandingsBeforeMatches():
    ...
    if set([name1, name2]) != set(
            ["Melpomene Murray", "Randy Schwartz"]):
        raise ValueError(
...
def testPairings():
    ...
    if len(pairings) != 4:
        raise ValueError(
            "For eight players, swissPairings should return 4 pairs. Got {pairs}".format(
                pairs=len(pairings)))
    [(pid1, pname1, pid2, pname2), (pid3, pname3, pid4, pname4), (pid5,
                                                                  pname5, pid6, pname6), (pid7, pname7, pid8, pname8)] = pairings
